 ...
 */
final class Version20220531074756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat_id INT DEFAULT NULL, ADD lieux_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP etat_id, DROP lieux_id');
    }
}
